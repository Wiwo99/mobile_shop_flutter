...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Product> favorites)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoritesState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Product> favorites)  $default,) {final _that = this;
switch (_that) {
case _FavoritesState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Product> favorites)?  $default,) {final _that = this;
switch (_that) {
case _FavoritesState() when $default != null:
return $default(_that.favorites);case _:
  return null;
...
class _FavoritesState implements FavoritesState {
  const _FavoritesState({final  List<Product> favorites = const []}): _favorites = favorites;
  

 final  List<Product> _favorites;
@override@JsonKey() List<Product> get favorites {
